...
HD_PWD='D:/Documents/Vivado/GOD/GOD.runs/axi_interconnect_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_interconnect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_interconnect.tcl

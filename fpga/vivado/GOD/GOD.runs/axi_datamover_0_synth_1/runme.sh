...
HD_PWD='D:/Documents/Vivado/GOD/GOD.runs/axi_datamover_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_datamover_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_datamover_0.tcl
